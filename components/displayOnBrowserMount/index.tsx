...
import { memo, useState, useEffect, DependencyList } from 'react';
 ...
 */
function DisplayOnBrowserMount(props: DisplayOnBrowserMountProps): JSX.Element | null {
...
export default memo(DisplayOnBrowserMount, IsEqual);
